...
document.addEventListener("DOMContentLoaded", function() {
  ...
  var container = document.querySelector(".category-item-container");

  // Get all the category items
  var categoryItems = document.querySelectorAll(".category-item");

  // Set the index and total number of items
  var currentIndex = 0;
  var totalItems = categoryItems.length;
  ...
  function showCurrentItem() {
    ...
    categoryItems[currentIndex].style.display = "block";
  }
...
var cards = Array.from(document.querySelectorAll(".card-info"));
...
function total() {
  ...
  searchButton.addEventListener('click', function() {
    ...
    // Perform search functionality or redirect to search results page
